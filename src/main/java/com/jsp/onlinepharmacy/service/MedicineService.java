...
public class MedicineService {
	...
	public ResponseEntity<ResponseStructure<Medicine>> updateMedicine(int medicineId, Medicine medicine) {
		Medicine dbMedicine=medicineDao.updateMdicine(medicineId,medicine);
		...
		if(dbMedicine!=null) {
			...
			throw new MedicalStoreIdNotFoundException("Sorry failed to update medicine");
		}
		
		
	}

	public ResponseEntity<ResponseStructure<Medicine>> getMedicineByIdMedicine(int medicineId) {
		...
		if(dbMedicine!=null) {
			...
			throw new MedicalStoreIdNotFoundException("Sorry failed to fetched medicine");
		}
	...
	public ResponseEntity<ResponseStructure<Medicine>> deleteMedicine(int medicineId) {
		...
		if(dbMedicine!=null) {
			...
			throw new MedicalStoreIdNotFoundException("Sorry failed to delete medicine");
		}
